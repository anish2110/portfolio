...
$('<img src="./assets/img/eduyear.png">'),
...
function closeMenu(){
    console.log('asda');
    document.getElementById('cst_menu_icon').classList.remove('js-menuOpen');
    document.getElementById('cst_global_nav').classList.remove('js-open');
}